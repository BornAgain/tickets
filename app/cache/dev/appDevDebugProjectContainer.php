...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'ticket.doctrine.history1' => 'getTicket_Doctrine_History1Service',
    ...
    {
        return $this->services['data_collector.dump'] = new \Symfony\Component\HttpKernel\DataCollector\DumpDataCollector($this->get('debug.stopwatch', ContainerInterface::NULL_ON_INVALID_REFERENCE), NULL, 'UTF-8', $this->get('request_stack'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'DB_TICKETS', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\ITSS\\TicketsBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\ITSS\\UserBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'ITSS\\TicketsBundle\\Entity');
        $c->addDriver($b, 'ITSS\\UserBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('ITSSTicketsBundle' => 'ITSS\\TicketsBundle\\Entity', 'ITSSUserBundle' => 'ITSS\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_41d8a413b2ad2008dbcbc4597d3c31d300b0aa9ad4b4facd1ee7288bd28988e7');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('ITSS\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('ITSS\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('ITSS\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('ITSS\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'ITSS\\UserBundle\\Entity\\User');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $k->add($h, array(0 => 'ROLE_SUPER_ADMIN'), NULL);
        $k->add($i, array(0 => 'ROLE_SUPER_ADMIN'), NULL);
    ...
    /**
     * Gets the 'ticket.doctrine.history1' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \ITSS\UserBundle\DoctrineListener\SystemHistory1 A ITSS\UserBundle\DoctrineListener\SystemHistory1 instance.
     */
    protected function getTicket_Doctrine_History1Service()
    {
        return $this->services['ticket.doctrine.history1'] = new \ITSS\UserBundle\DoctrineListener\SystemHistory1($this);
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\ITSS\\TicketsBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\ITSS\\TicketsBundle/Resources/views'), 'ITSSTickets');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\ITSS\\UserBundle/Resources/views'), 'ITSSUser');
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_CONSULTANT' => array(0 => 'ROLE_USER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_CONSULTANT')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ITSSTicketsBundle' => 'ITSS\\TicketsBundle\\ITSSTicketsBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'ITSSUserBundle' => 'ITSS\\UserBundle\\ITSSUserBundle',
            ...
            'fos_user.model.user.class' => 'ITSS\\UserBundle\\Entity\\User',
